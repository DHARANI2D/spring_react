...
class CreateEmployeeComponent extends Component {
    ...
    saveOrUpdateEmployee = (e) => {
        e.preventDefault();
        let employee = {firstName: this.state.firstName, lastName: this.state.lastName, completed:this.state.completed,emailId: this.state.emailId};
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <div className = "form-group">
                                            <label> Task: </label>
                                            <input placeholder="Task" name="lastName" className="form-control" 
                                                value={this .state.lastName} onChange={this.changeLastNameHandler}/>
                                        </div>
                                        <div className = "form-group">
                                            <label> Status  </label>
                                            <input placeholder="Status" name="completed" className="form-control" 
